...
{
    private Health1 h1; // Tham chiếu đến Health1
    public Image myImage1; // Kéo thả thanh máu vào đây từ Inspector
    ...
    void Start()
    {
        h1 = FindObjectOfType<Health1>(); // Tìm Health1
        // Lấy chiều rộng
